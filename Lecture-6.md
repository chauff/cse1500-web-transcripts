...
:point_up: You see here that modules often depend on a number of other modules (in this case: 30 dependencies). As Express is a very popular module, it is listed as dependency in more than 27,000 other modules.
 ...
 For the **frontend** side, adding more npm dependencies can lead to an increase of data traffic, which can be easily reduced by removing unused libraries. With the *Coverage* tab in the DevTools of Chrome you can see all unused CSS and JS code in your application.

 ![Modules](img/L6-coverage.png)
