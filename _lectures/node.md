...
<details>
<summary>True or False? An Ajax request always has to be sent as part of an HTML form element.</summary>
False.
</details>

<details>
<summary>True or False? An Ajax request is not sent via http, but instead via atp, the Ajax transfer protocol.</summary>
False.
</details>

<details>
<summary>True or False? An Ajax request looks like any other http request.</summary>
True.
</details>

<details>
<summary>True or False? An Ajax request is never actually sent to an origin Web server, the reply is always generated by a Web cache.</summary>
False.
</details>
