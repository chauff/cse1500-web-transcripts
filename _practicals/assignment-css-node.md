...
| 2    | Source code                                        |
| 3    | -                                                  |
| 4 (optional) | →→→ upload URL to TUD's Stack Overflow community         |
...
Next, tackle the CSS for your **game screen**. The look of the game screen should be coherent with the splash screen. The two are likely to share basic CSS settings (colors, fonts, etc.) - make sure that you are efficient and do not duplicate existing CSS code. 
...
Once you have deployed or recorded your app, head over to our TUD Stack Overflow community [https://stackoverflow.com/c/tud-cs](https://stackoverflow.com/c/tud-cs), find your article and post the URL to the game or the screencast. Add the tag `screencast` if you have a screencast to show off, or `deployed` if you deployed your game for others to play - this makes it easier for everyone else to find your game!
